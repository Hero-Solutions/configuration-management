...
-->
	...
	<xsd:complexType name="actorComplexType">
		...
		<xsd:sequence>
			...
			<xsd:element name="vitalDatesActor" minOccurs="0" maxOccurs="unbounded">
				<xsd:annotation>
       ...
       <xsd:complexType>
               <xsd:complexContent>
                       <xsd:extension base="lido:dateComplexType">
                               <xsd:attribute ref="lido:type">
                                       <xsd:annotation>
                                               <xsd:documentation>
                                                       An attribute for the kind
...
<xsd:element name="vitalPlaceActor" minOccurs="0" maxOccurs="unbounded">
       <xsd:annotation>
               <xsd:documentation>
                       An index element for the place where the
                               ...
                               If the place is in dispute, omit the place.
               </xsd:documentation>
       </xsd:annotation>
       <xsd:complexType>
               <xsd:complexContent>
                       <xsd:extension base="lido:placeComplexType">
                               <xsd:attribute ref="lido:type">
                                       <xsd:annotation>
                                               <xsd:documentation>
                                                       An attribute for the kind
...
"measurementType" are mandatory.</xsd:documentation>
	...
	<xsd:sequence>
<xsd:element name="displayRelatedWork" type="lido:textComplexType" minOccurs="0" maxOccurs="unbounded" id="displayRelatedWork">
    <xsd:annotation>
        <xsd:documentation>
            A display element for the description of the related object or work, corresponding to the subsequent
            Related Work
            element, including identifying information about the object and, possibly, information about the kind of the relation.
            <br/>
            Repeated for language variants only.
        </xsd:documentation>
    </xsd:annotation>
</xsd:element>
